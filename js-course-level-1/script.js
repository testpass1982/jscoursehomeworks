...
$(document).ready(function () {
    ...
    function task1() {
        ...
        console.log(`a=${a}`); // a равно 3 (потому что она увеличивалась на 1 дважды - в строке 9 и в строке 15)
        console.log(`b=${b}`); // b равно 3 (потому что она увеличивалась на 1 в строке 11 и в строке 19)
    };
    ...
    console.log('*****task6*****');
    console.log('*****solution on html-page*****');
});